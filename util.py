...
class DATA_LOADER(object):
	...
	def load_dataset(self):
		trainval_label= self.train_label
		trainval_feature = self.train_feature
		test_seen_feature = self.test_seen_feature
		test_seen_label = self.test_seen_label

		print('test_seen_label',test_seen_label.shape)
		print('trainval_label',trainval_label.shape)



		train_label = torch.cat((trainval_label,test_seen_label),0)
		train_feature =torch.cat((trainval_feature,test_seen_feature),0)
		#print('train_label',train_label.shape)
		#print('attribute',self.attribute.shape)
		att =	self.attribute[train_label]
		return train_label, att, train_feature
